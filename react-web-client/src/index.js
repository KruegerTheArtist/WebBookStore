    ...
    ReactDOM.render(
        <React.StrictMode>
            <BrowserRouter>
                ...
                <App dispatch={store.dispatch.bind(store)} state={state} painterStyleMethods={painterStyleMethods} bookMethods={bookMethods} authorMethods={authorMethods} interpreterMethods={interpreterMethods} painterMethods={painterMethods} publisherMethods={publisherMethods} coverTypeMethods={coverTypeMethods} />
            </BrowserRouter>
        </React.StrictMode>,
