...
const AddBook = (props) => {
    ...
    let add = () => {
        ...
        props.addBook.bookMethods.addBook(currentName, currentPublishDate,currentCoverTypeName, currentDescription, currentFormat, currentCountPage, currentPrice, currentWeight, currentDuplicate, currentAgeLimit, currentPublisherName);
    }
